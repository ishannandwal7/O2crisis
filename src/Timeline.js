...
<section id="cd-timeline" className="cd-container">
		<div className="cd-timeline-block">
			...
			<div className="cd-timeline-content">
				<h2>where it all begin</h2>
				<p>
					i was in my first semester. when i want to explore different field to find interest.i taught that it will be challenging to involve myself in webdevelopment. 
				</p>
		...
		<div className="cd-timeline-block">
			<div className="cd-timeline-img cd-location">
				<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/148866/cd-icon-picture.svg" alt="Movie"/>
			</div> 
